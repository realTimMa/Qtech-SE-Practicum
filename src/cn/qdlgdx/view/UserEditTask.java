 ...
 *
 */
public class UserEditTask extends JInternalFrame {
...
//	}
	 ...
	 * Create the frame.
	 */
	public UserEditTask(String usrName) {
		setTitle("\u7F16\u8F91\u4EFB\u52A1");
...
//				if (taskPfmc.length() < 50) {
				int flag = UserDao.updateTask(usrName, taskId, taskPfmc);
				if (flag == 0) {
...
//				}
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				UserEditTask.this.setVisible(false);
			}
		});
